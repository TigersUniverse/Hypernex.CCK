...
namespace Hypernex.CCK.Unity.Editor.Editors
{
    ...
    public class FaceTrackingDescriptorEditor : UnityEditor.Editor
    {
        ...
        private void OnListCallback(SerializedProperty property, int i, int val)
        {
        ...
        private void OnEnable()
        {
            ...
            BlendshapeListDrawer.OnListCallback += OnListCallback;
        }

        private void OnDisable() => BlendshapeListDrawer.OnListCallback -= OnListCallback;
