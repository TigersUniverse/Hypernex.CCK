...
namespace Hypernex.CCK.Unity.Editor
{
    ...
    public static class EditorUtils
    {
        ...
        static EditorUtils()
        {
            ...
            AssetIdentifier.OnRequestAlign += identifier =>
            {
                GameObject gameObject = identifier.gameObject;
                ...
                if(w != null)
                    identifier.MoveComponent(w, false);
                if(a != null)
                    identifier.MoveComponent(a, false);
                if(l != null)
                    identifier.MoveComponent(l, false);
                if(f != null)
                    identifier.MoveComponent(f, false);
                if(g != null)
                    identifier.MoveComponent(g, false);
                if(n != null)
                    identifier.MoveComponent(n, false);
                if(r != null)
                    identifier.MoveComponent(r, false);
                if(v != null)
                    identifier.MoveComponent(v, false);
            };
        }
