    ...
    public static class Security
    {
        ...
        public static Component[] GetOffendingComponents(Scene scene, Type[] additionalTypes = null) =>
            GetOffendingComponents(
                Object.FindObjectsOfType<Transform>(true).Where(x => x.gameObject.scene == scene).ToArray(),
                GetAllowedWorldComponents(additionalTypes));
        ...
        public static void RemoveOffendingItems(Scene scene, Type[] additionalTypes = null) => RemoveOffendingItems(
            Object.FindObjectsOfType<Transform>().Where(x => x.gameObject.scene == scene).ToArray(),
            GetAllowedWorldComponents(additionalTypes));
        ...
        public static void ApplyComponentRestrictions(Scene scene) => ApplyComponentRestrictions(
            Object.FindObjectsOfType<Transform>(true).Where(x => x.gameObject.scene == scene).Select(x => x.gameObject),
            true);
